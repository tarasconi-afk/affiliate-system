...
- `src/content/pages/decision-compares/mandril-10mm-ou-13mm.json`
...
- `src/pages/index.astro`: homepage editorial com links para os 10 PageSpecs locais e explicação da metodologia.
...
- `src/pages/sitemap.xml.ts`: gera XML com a homepage e os artigos da coleção; com os 10 PageSpecs locais atuais, serão geradas 11 URLs indexáveis quando esse estado for publicado.
